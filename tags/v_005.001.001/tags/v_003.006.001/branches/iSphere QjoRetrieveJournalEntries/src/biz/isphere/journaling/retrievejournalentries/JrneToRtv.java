package biz.isphere.journaling.retrievejournalentries;
...
public class JrneToRtv {
    ...
    private static final String FMTMINDTA_NO = "*NO";
    private static final String FMTMINDTA_YES = "*YES";
    private static final String ENTTYP_ALL = "*ALL";
    private static final String ENTTYP_RCD = "*RCD";
    private static final String JRNCDE_ALLSLT = "*ALLSLT";
    private static final String JRNCDE_CTL = "*CTL";
    private static final String JRNCDE_ALL = "*ALL";
    private static final String FRMENT_FIRST = "*FIRST";
    private static final String RCVRNG_CURRENT = "*CURRENT";
    private static final String RCVRNG_CURCHAIN = "*CURCHAIN";
