...
public class MessageFileSearchPage extends XDialogPage implements ISearchPage, Listener {
    ...
    private void createSearchStringEditorGroup(Composite aMainPanel) {
        searchArgumentsListEditor = new SearchArgumentsListEditor(SearchOptions.ARGUMENTS_SIZE, false,
            SearchOptionConfig.getAdditionalMessageFileSearchOptions());
    ...
    private void loadFilterPoolsOfConnection(String connectionName) {
        ...
        ISystemFilterPoolReference[] systemFilterPoolReferences = RSEFilterHelper.getConnectionFilterPools(connectionName);
