...
public class JobLogExplorerSpooledFileInput2 extends AbstractJobLogExplorerInput {
    ...
    public JobLogExplorerSpooledFileInput2(String connectionName, String splfName, int splfNumber, String jobName, String userName, String jobNumber) {
    ...
    public JobLogExplorerSpooledFileInput2(String connectionName, String splfName, int splfNumber, String jobName, String userName, String jobNumber,
        String jobSystemName, String creationDate, String creationTime) {
        ...
        DateTimeHelper.combineDateTime(tCreationDate, tCreationTime);
    }
    ...
    public String getToolTipText() {
        // return localSpooledFilePath.getLocation().toOSString();
