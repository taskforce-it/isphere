 ...
 * of private attributes used by <code>SourceMemberTextMergeViewer</code>, such 
 * as <code>Range</code> and <code>fComposite</code>. 
 * <p>
 ...
 * @see TextMergeViewer
 */
public abstract class SourceMemberContentMergeViewer extends ContentViewer
	 ...
	 */
	protected SourceMemberContentMergeViewer(int style, ResourceBundle bundle, CompareConfiguration cc) {
		...
		fPropertyChangeListener= new IPropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent event) {
				SourceMemberContentMergeViewer.this.handlePropertyChangeEvent(event);
			}
		};
	...
	protected final Control buildControl(Composite parent) {
		...
		fComposite= new Composite(parent, fStyles | SWT.LEFT_TO_RIGHT) { // we force a specific direction
			public boolean setFocus() {
				return SourceMemberContentMergeViewer.this.handleSetFocus();
			}
		};
