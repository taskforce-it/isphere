...
package biz.isphere.core.compare.contentmergeviewer;
...
import biz.isphere.core.compare.internal.merge.SourceMemberDocumentMerger;
import biz.isphere.core.compare.internal.merge.SourceMemberDocumentMerger.Diff;
import biz.isphere.core.compare.internal.merge.SourceMemberDocumentMerger.IDocumentMergerInput;

import com.ibm.icu.text.MessageFormat;

/**
 * iSphere: This class has been duplicated from the Eclipse code base because
 * it has to produce a <code>SourceMemberDocumentMerger</code> instead of a 
 * <code>DocumentMerger</code>.
 * <p>
 ...
 */
public class SourceMemberTextMergeViewer extends SourceMemberContentMergeViewer implements IAdaptable {
    ...
    private SourceMemberDocumentMerger fMerger;
    /** The current diff */
    ...
    class ContributorInfo implements IElementStateListener, VerifyListener, IDocumentListener, IEncodingSupport {
        ...
        public ContributorInfo(SourceMemberTextMergeViewer viewer, Object element, char leg) {
            fViewer = viewer;
            fElement = element;
            fLeg = leg;
                ...
                if (parent instanceof IDocumentRange) {
                    ...
                    if (range == null) {
                        ...
                        try {
                            ...
                            // silently ignored
                            if (SourceMemberTextMergeViewer.DEBUG) System.out.println("BadPositionCategoryException: " + ex);   //$NON-NLS-1$
                        } catch (BadLocationException ex) {
                            // silently ignored
                            if (SourceMemberTextMergeViewer.DEBUG) System.out.println("BadLocationException: " + ex);   //$NON-NLS-1$
                        }
        ...
        private void updateViewerDocumentRange(MergeSourceViewer tp, Position range) {
            ...
            if (this.fViewer.fSubDoc) {
                if (range != null) {
                    IRegion r= this.fViewer.normalizeDocumentRegion(tp.getSourceViewer().getDocument(), SourceMemberTextMergeViewer.toRegion(range));
        ...
        private void updateViewerDocument(MergeSourceViewer tp, IDocument document, Position range) {
            ...
            if (this.fViewer.fSubDoc) {
                if (range != null) {
                    IRegion r= this.fViewer.normalizeDocumentRegion(document, SourceMemberTextMergeViewer.toRegion(range));
        ...
        public void documentChanged(DocumentEvent e) {
            ...
            SourceMemberTextMergeViewer.this.documentChanged(e, dirty);
     ...
     */
    public SourceMemberTextMergeViewer(Composite parent, CompareConfiguration configuration) {
     ...
     * @param configuration the configuration object
     */
    public SourceMemberTextMergeViewer(Composite parent, int style, CompareConfiguration configuration) {
        super(style, ResourceBundle.getBundle(BUNDLE_NAME), configuration);

        operationHistoryListener = new IOperationHistoryListener() {
            public void historyNotification(OperationHistoryEvent event) {
                SourceMemberTextMergeViewer.this.historyNotification(event);
            }
        };
        OperationHistoryFactory.getOperationHistory()
                .addOperationHistoryListener(operationHistoryListener);

        fMerger = new SourceMemberDocumentMerger(new IDocumentMergerInput() {
            public ITokenComparator createTokenComparator(String line) {
                return SourceMemberTextMergeViewer.this.createTokenComparator(line);
            }
            public CompareConfiguration getCompareConfiguration() {
                return SourceMemberTextMergeViewer.this.getCompareConfiguration();
            }
            ...
            public int getHunkStart() {
                return SourceMemberTextMergeViewer.this.getHunkStart();
            }
            ...
            public boolean isIgnoreAncestor() {
                return SourceMemberTextMergeViewer.this.isIgnoreAncestor();
            }
            public boolean isPatchHunk() {
                return SourceMemberTextMergeViewer.this.isPatchHunk();
            }
            ...
            public boolean isThreeWay() {
                return SourceMemberTextMergeViewer.this.isThreeWay();
            }
            public boolean isPatchHunkOk() {
                return SourceMemberTextMergeViewer.this.isPatchHunkOk();
            }
        ...
        fPreferenceChangeListener= new IPropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent event) {
                SourceMemberTextMergeViewer.this.handlePropertyChangeEvent(event);
            }
        };
...
//            String fontName= clazz.getName();
            String fontName= TextMergeViewer.class.getName();
