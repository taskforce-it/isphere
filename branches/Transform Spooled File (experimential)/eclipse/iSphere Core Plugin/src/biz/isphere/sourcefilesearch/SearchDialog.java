...
public class SearchDialog extends Dialog {
	...
	public SearchDialog(Shell parentShell, HashMap<String, SearchElement> searchElements) {
		...
		// searchString = store.getString("DE.TASKFORCE.ISPHERE.SOURCEFILESEARCH.SEARCHSTRING");
	...
	protected void okPressed() {
        // TODO: Remove disabled statements 'DE.TASKFORCE'
		// store.setValue("DE.TASKFORCE.ISPHERE.SOURCEFILESEARCH.SEARCHSTRING", textString.getText().trim());
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(Messages.getString("iSphere_Source_File_Search"));
	}
