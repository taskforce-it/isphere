...
public class TN5250jFileFilter extends FileFilter {
     ...
     * TN5250jFileFilter("jpg", "JPEG Image Images"); Note that the "." before
     ...
     * TN5250jFileFilter(String {"gif", "jpg"}); Note that the "." before the
     ...
     * those that end in ".jpg" and ".tif": TN5250jFileFilter filter = new
     * TN5250jFileFilter(); filter.addExtension("jpg");
