...
public class HexCharMapDialog {
    ...
    public HexCharMapDialog(Component parent, ICodePage codepage) {
        ...
        // we will use a collator here so that we can take advantage of the
        // locales
     ...
     * Displays the dialog
     * 
     * @return a String, containing the selected character OR null, if nothing
     *         was selected
     */
    public String showModal() {
        ...
        int result = JOptionPane.showOptionDialog(parent, // the parent that the
                                                          // dialog blocks
