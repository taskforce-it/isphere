 ...
 * component that controls two internal JLists for the selection of what is to
 * be included and not included on the two sides of a list.
 */
public class TN5250jMultiSelectList extends JComponent {
    ...
    /**
     * Constructs a <code>TN5250jMultiSelectList</code> that displays the
     * elements in the specified non-null model. All
     * <code>TN5250jMultiSelectList</code> constructors delegate to this one.
     */
    ...
    /**
     * Constructs a <code>TN5250jMultiSelectList</code> that displays the
     * elements in the specified array. This constructor just delegates to the
    ...
    /**
     * Constructs a <code>TN5250jMultiSelectList</code> that displays the
     * elements in the specified Vector. This constructor just delegates to the
    ...
    /**
     * Creates a new <code>TN5250jMultiSelectList</code> component with an empty
     * model.
     */
    ...
    /**
     * Creates a new <code>TN5250jMultiSelectList</code> component with an empty
     * model and the specified horizontal gap between components.
     */
    public TN5250jMultiSelectList(int hgap) {
        ...
        selectItemButton = initButton(new SelectionButton(SELECT_ITEM), LangTool.getString("oaa.AddSelected"));
        selectAllButton = initButton(new SelectionButton(SELECT_ALL), LangTool.getString("oaa.AddAll"));
        deselectItemButton = initButton(new SelectionButton(DESELECT_ITEM), LangTool.getString("oaa.RemoveSelected"));
        deselectAllButton = initButton(new SelectionButton(DESELECT_ALL), LangTool.getString("oaa.RemoveAll"));
    ...
    /**
     * Returns the first index argument from the most recent an interval
     * selection.
     */
    ...
    /**
     * Returns the second index argument from the most recent an interval
     * selection.
     */
    ...
    /**
     * Move the selected items from one list and also select the next item in
     * the list.
     * 
    ...
    private class EventHandler implements ActionListener, ListSelectionListener, Serializable {
        ...
        public void valueChanged(ListSelectionEvent e) {
            if (e.getSource() == TN5250jMultiSelectList.this.mainList) {
                TN5250jMultiSelectList.this.fireSelectionValueChanged(e.getFirstIndex(), e.getLastIndex(), e.getValueIsAdjusting());
            }
