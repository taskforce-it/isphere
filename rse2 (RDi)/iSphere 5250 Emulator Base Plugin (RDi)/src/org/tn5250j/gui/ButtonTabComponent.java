/**
 * $Id: ButtonTabComponent.java 1119 2011-02-23 22:33:14Z master_jaf $
 * 
 * Title: tn5250J
 ...
 * <br>
 * This class based on the ButtonTabComponent example from Sun Microsystems,
 * Inc. and was modified to use tool tips, other layout and stuff.
 */
public final class ButtonTabComponent extends JPanel implements SessionListener {
    ...
    /**
     * Notify all the tab listeners that this specific tab was selected to
     * close.
     * 
     * @param tabToClose
     */
    ...
    /**
     * Label delegating icon and text to the corresponding tab. Implementing
     * MouseListener is a workaround, cause when applying a tool tip to the
     * JLabel, clicking the tabs doesn't work (tested on Tn5250j0.6.2;
     * WinXP+WinVista+Win7; JRE 1.6.0_20+).
     */
    ...
    private final class TabButton extends JButton implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (i != -1) {
                fireTabClosed(i);
                // hint: the actual close will be done within the TabbedPane
                // Container
            }
        }
