 ...
 * <code>WizardPages</code> and add <code>WizardListener</code>'s for all your
 * Wizard fun.
 */
public class Wizard extends JPanel {
    ...
    public boolean next() {
        ...
        Component current_page = null, next_page = null;
    ...
    public boolean previous() {
        ...
        Component current_page = null, previous_page = null;
    ...
    public void addWizardListener(WizardListener l) {
        if (listeners == null) listeners = new Vector<WizardListener>(3);
    ...
    /**
     * A listener on the "next" button that is implemented as an anonymous inner
     * class that simply invokes the containing classes "next()" method.
     * 
     * @see #next
     */
     ...
     * inner class that simply invokes the containing classes "finish()" method.
     * 
     * @see #finish
     */
     ...
     * inner class that simply invokes the containing classes "cancel()" method.
     * 
     * @see #cancel
     */
    ...
    /**
     * A listener on the "help" button that is implemented as an anonymous inner
     * class that simply invokes the containing classes "help()" method.
     * 
     * @see #help
     */
     ...
     * listeners to the buttons of the children so that the container knows when
     * to post the proper "Wizard" events.
     */
    transient protected ContainerListener containerListener = new ContainerListener() {
