...
public class DisplayAttributesPanel extends AttributesPanel {
    ...
    public void initPanel() throws Exception {
        ...
        // since this is a new property added then it might not exist in
        // existing
    ...
    public void applyAttributes() {
        ...
        if (csHide.isSelected()) {
            changes.firePropertyChange(this, "colSeparator", getStringProperty("colSeparator"), "Hide");
            setProperty("colSeparator", "Hide");
        } else if (csLine.isSelected()) {
            changes.firePropertyChange(this, "colSeparator", getStringProperty("colSeparator"), "Line");
            setProperty("colSeparator", "Line");
        } else if (csShortLine.isSelected()) {
            changes.firePropertyChange(this, "colSeparator", getStringProperty("colSeparator"), "ShortLine");
            setProperty("colSeparator", "ShortLine");
        } else {
            changes.firePropertyChange(this, "colSeparator", getStringProperty("colSeparator"), "Dot");
            setProperty("colSeparator", "Dot");
        }

        if (saNormal.isSelected()) {
            changes.firePropertyChange(this, "showAttr", getStringProperty("showAttr"), "Normal");
            setProperty("showAttr", "Normal");
        } else {
            changes.firePropertyChange(this, "showAttr", getStringProperty("showAttr"), "Hex");
            setProperty("showAttr", "Hex");

        }

        if (guiCheck.isSelected()) {
            changes.firePropertyChange(this, "guiInterface", getStringProperty("guiInterface"), YES);
            setProperty("guiInterface", YES);
        } else {
            changes.firePropertyChange(this, "guiInterface", getStringProperty("guiInterface"), NO);
            setProperty("guiInterface", NO);
        }

        if (guiShowUnderline.isSelected()) {
            changes.firePropertyChange(this, "guiShowUnderline", getStringProperty("guiShowUnderline"), YES);
            setProperty("guiShowUnderline", YES);
        } else {
            changes.firePropertyChange(this, "guiShowUnderline", getStringProperty("guiShowUnderline"), NO);
