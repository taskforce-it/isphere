...
public class CursorAttributesPanel extends AttributesPanel {
    ...
    public void initPanel() throws Exception {
        ...
        if (getStringProperty("rulerFixed").equals("Yes")) rulerFixed.setSelected(false);
    ...
    public void applyAttributes() {
        ...
        if (cFull.isSelected()) {
            changes.firePropertyChange(this, "cursorSize", getStringProperty("cursorSize"), "Full");
            setProperty("cursorSize", "Full");

        }
        if (cHalf.isSelected()) {
            changes.firePropertyChange(this, "cursorSize", getStringProperty("cursorSize"), "Half");
            setProperty("cursorSize", "Half");
        }
        if (cLine.isSelected()) {
            changes.firePropertyChange(this, "cursorSize", getStringProperty("cursorSize"), "Line");

            setProperty("cursorSize", "Line");
        }

        if (chNone.isSelected()) {
            changes.firePropertyChange(this, "crossHair", getStringProperty("crossHair"), "None");
            setProperty("crossHair", "None");

        }

        if (chHorz.isSelected()) {
            changes.firePropertyChange(this, "crossHair", getStringProperty("crossHair"), "Horz");
            setProperty("crossHair", "Horz");

        }

        if (chVert.isSelected()) {
            changes.firePropertyChange(this, "crossHair", getStringProperty("crossHair"), "Vert");
            setProperty("crossHair", "Vert");

        }

        if (chCross.isSelected()) {
            changes.firePropertyChange(this, "crossHair", getStringProperty("crossHair"), "Both");
            setProperty("crossHair", "Both");

        }

        if (rulerFixed.isSelected()) {
            changes.firePropertyChange(this, "rulerFixed", getStringProperty("rulerFixed"), "No");
            setProperty("rulerFixed", "No");
        } else {
            changes.firePropertyChange(this, "rulerFixed", getStringProperty("rulerFixed"), "Yes");
            setProperty("rulerFixed", "Yes");
        }

        changes.firePropertyChange(this, "cursorBottOffset", getStringProperty("cursorBottOffset"), cursorBottOffset.getText());
        setProperty("cursorBottOffset", cursorBottOffset.getText());

        if (blink.isSelected()) {
            changes.firePropertyChange(this, "cursorBlink", getStringProperty("cursorBlink"), "Yes");
            setProperty("cursorBlink", "Yes");
        } else {

            changes.firePropertyChange(this, "cursorBlink", getStringProperty("cursorBlink"), "No");
