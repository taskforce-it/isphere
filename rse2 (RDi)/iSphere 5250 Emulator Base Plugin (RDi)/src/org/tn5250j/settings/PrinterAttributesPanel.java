...
public class PrinterAttributesPanel extends AttributesPanel {
    ...
    public void initPanel() throws Exception {
        ...
        if (getStringProperty("print.portWidth").length() != 0 && getStringProperty("print.portHeight").length() != 0
            ...
            pappyPort.setImageableArea(Double.parseDouble(getStringProperty("print.portImage.X")),
                Double.parseDouble(getStringProperty("print.portImage.Y")), Double.parseDouble(getStringProperty("print.portImageWidth")),
        ...
        if (getStringProperty("print.landWidth").length() != 0 && getStringProperty("print.landHeight").length() != 0
            ...
            pappyLand.setImageableArea(Double.parseDouble(getStringProperty("print.landImage.X")),
                Double.parseDouble(getStringProperty("print.landImage.Y")), Double.parseDouble(getStringProperty("print.landImageWidth")),
    ...
    public void applyAttributes() {
        ...
        changes.firePropertyChange(this, "print.portImageWidth", getStringProperty("print.portImageWidth"),
            Double.toString(pappyPort.getImageableWidth()));
        ...
        changes.firePropertyChange(this, "print.portImageHeight", getStringProperty("print.portImageHeight"),
            Double.toString(pappyPort.getImageableHeight()));
        ...
        changes.firePropertyChange(this, "print.landImageWidth", getStringProperty("print.landImageWidth"),
            Double.toString(pappyLand.getImageableWidth()));
        ...
        changes.firePropertyChange(this, "print.landImageHeight", getStringProperty("print.landImageHeight"),
            Double.toString(pappyLand.getImageableHeight()));
