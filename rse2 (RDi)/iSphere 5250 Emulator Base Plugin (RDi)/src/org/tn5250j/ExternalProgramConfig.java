...
public class ExternalProgramConfig {
    ...
    private final Properties loadExternalProgramSettings() {
        ...
        try {
            etnProps = ConfigureFactory.getInstance().getProperties(EXTERNAL_PROGRAM_REGISTRY_KEY, EXTERNAL_PROGRAM_PROPERTIES_FILE_NAME, false,
                "Default Settings");
            ...
            if (etnProps.size() == 0) {
                ...
                ConfigureFactory.getInstance().saveSettings(EXTERNAL_PROGRAM_REGISTRY_KEY, EXTERNAL_PROGRAM_PROPERTIES_FILE_NAME,
    ...
    public static String doEntry(Frame parent, String propKey, Properties props2) {
        ...
        addLabelComponent(LangTool.getString("customized.name"), name, etnp);

        addLabelComponent(LangTool.getString("customized.window"), wCommand, etnp);
        addLabelComponent(LangTool.getString("customized.unix"), uCommand, etnp);
