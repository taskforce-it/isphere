...
/**
 * IBM i 7.1 Information Center > Programmierung > i5/OS globalization >
 * Globalization reference information > Keyboard reference information
 * 
 * @see <a
 *      href="http://publib.boulder.ibm.com/infocenter/iseries/v7r1m0/index.jsp?topic=/nls/rbagsnatlangkeybrdtype.htm">National
 *      language keyboard types and SBCS code pages</a>
 */
public enum KbdTypesCodePages {
    ...
    PLBX ("Polish 870-pl", "PLB", "959", "870", "870-pl"), // Workaround, to
                                                           // catch up Java
                                                           // codepage '870-pl'
    ...
    SKBX ("Slovakian 870-sk", "SKB", "959", "870", "870-sk"), // Workaround, to
                                                              // catch up Java
                                                              // codepage
                                                              // '870-sk'
    ...
    public String toString() {
        return "[description=" + description + ", kbdType=" + kbdType + ", charset=" + charset + ", codepage=" + codepage + ", ccsid=" + ccsid + "]";
    }
