 ...
 */
public class Gui5250Frame extends GUIViewInterface implements ChangeListener, TabClosedListener, SessionListener, SessionJumpListener {
    ...
    /**
     * Sets the main frame title to the same as the current selected tab's
     * title.
     * 
     ...
     * (non-Javadoc)
     * @see
     * org.tn5250j.interfaces.GUIViewInterface#addSessionView(java.lang.String,
     * org.tn5250j.SessionGUI)
     */
    @Override
    public void addSessionView(final String tabText, final SessionPanel sesspanel) {
        ...
        if (hideTabBar && sessTabbedPane.getTabCount() == 0 && !embedded) {
            // put Session just in the main content window and don't create any
            // tabs
     ...
     * (non-Javadoc)
     * @see
     * org.tn5250j.interfaces.GUIViewInterface#removeSessionView(org.tn5250j
     * .SessionGUI)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.tn5250j.interfaces.GUIViewInterface#onSessionChanged(org.tn5250j.
    ...
    /*
     * (non-Javadoc)
     * @see org.tn5250j.interfaces.GUIViewInterface#containsSession(org.tn5250j.
     * SessionGUI)
     */
    @Override
