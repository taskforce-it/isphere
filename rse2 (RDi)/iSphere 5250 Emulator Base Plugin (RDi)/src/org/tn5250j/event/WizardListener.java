...
public interface WizardListener {
    ...
    /**
     * Invoked <i>before</i> advancing to the next page. Calling
     * <code>e.setAllowChange(false)</code> will prevent the next page from
     * being advanced too. Check the <code>e.isLastPage()</code> to see if you
    ...
    /**
     * Invoked <i>before</i> advancing to the previous page. Calling
     * <code>e.setAllowChange(false)</code> will prevent the previous page from
     * being advanced too.
     */
