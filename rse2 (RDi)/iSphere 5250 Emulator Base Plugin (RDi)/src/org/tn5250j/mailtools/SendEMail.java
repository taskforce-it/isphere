...
public class SendEMail {
    ...
    private boolean loadConfig(String name) throws Exception {
        ...
        SMTPProperties = ConfigureFactory.getInstance().getProperties("smtp", "SMTPProperties.cfg");
    ...
    public boolean send() throws Exception {
        ...
        try {
            if (!loadConfig(configFile)) return false;
            ...
            if (subject != null) msg.setSubject(subject.trim());

            if (from == null) from = SMTPProperties.getProperty("mail.smtp.from");
    ...
    private void showFailedException(SendFailedException sfe) {
        ...
        JOptionPane.showMessageDialog(null, errorScrollPane, LangTool.getString("em.titleConfirmation"), JOptionPane.ERROR_MESSAGE);
