...
public final class ConsoleLogger implements TN5250jLogger {
    ...
    public void debug(Object message) {
        if (isDebugEnabled()) System.out.println("DEBUG [" + clazz + "] " + ((message != null) ? message.toString() : ""));
    }
    ...
    public void info(Object message) {
        if (isInfoEnabled()) System.out.println("INFO [" + clazz + "] " + ((message != null) ? message.toString() : ""));
    }
    ...
    public void warn(Object message) {
        if (isWarnEnabled()) System.err.println("WARN [" + clazz + "] " + ((message != null) ? message.toString() : ""));
    }
    ...
    public void error(Object message) {
        if (isErrorEnabled()) System.err.println("ERROR [" + clazz + "] " + ((message != null) ? message.toString() : ""));
    }
    ...
    public void fatal(Object message) {
        if (isFatalEnabled()) System.err.println("FATAL [" + clazz + "] " + ((message != null) ? message.toString() : ""));
    }
