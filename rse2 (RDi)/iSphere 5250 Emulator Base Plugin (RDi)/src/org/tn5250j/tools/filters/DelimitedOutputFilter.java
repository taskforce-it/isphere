        ...
        public DelimitedDialog(JFrame parent) {
            ...
            if (delimiter.length() > 0)
                if (delimiter.equals("\t"))
                    ...
                    if (!delimiter.equals(",") && !delimiter.equals(";") && !delimiter.equals(":") && !delimiter.equals("|")) fd.addItem(delimiter);
            ...
            if (stringQualifier.length() > 0) {
                if (!stringQualifier.equals("'") && !stringQualifier.equals("\"")) td.addItem(stringQualifier);
            ...
            int result = JOptionPane.showOptionDialog(parent, // the parent that
                ...
                LangTool.getString("delm.title"), // the title of the dialog
                                                  // window
            ...
            case 0: // change options
                ...
                if (delimiter.equals(LangTool.getString("delm.labelSpace"))) delimiter = " ";
                if (delimiter.equals(LangTool.getString("delm.labelTab"))) delimiter = "\t";
                if (delimiter.equals(LangTool.getString("delm.labelNone"))) delimiter = "";
