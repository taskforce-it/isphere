 ...
 * 
 * @author Slava Pestov
 * @version $Id: OperatingSystem.java 843 2009-03-18 22:52:42Z master_jaf $
 * @since jEdit 4.0pre4
 */
public class OperatingSystem {
    ...
    public static void displayURL(String url) {
        ...
        // We now check if we have a property defined for the external program
        // to
        ...
        if (props.getProperty("emul.protocol." + protocol, "").trim().length() > 0) {
            ...
            urlParm[0] = url;
            if (commandTemplate.lastIndexOf("{0}") == -1) commandTemplate += " {0}";
        ...
        // execute the command if there was one if not then fall through to
        // generic
        // processing.
    ...
    /**
     * @param url
     * @return true when found external program and has been launched; false
     *         when not found external program.
     */
    ...
    static {
        ...
        if (System.getProperty("java.version").compareTo("1.4") >= 0) java14 = true;
