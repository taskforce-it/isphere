 ...
 * individual rows and columns. <code>ENHGridLayout</code> uses the widest
 * element in a column to set the width of that column, and the tallest element
 * in a row to set the height of that row.
 */
