...
public class DESSHA1 implements Serializable {
    ...
    /**
     * used to hash passwords and other key data to fireSend over the wire, to
     * prevent plaintext transmit.
     * 
     ...
     * a String in hexadecimal format. This is used internally by
     * <code>digest()</code>. Data is returned in the format specified by the
     * Jabber protocol.
     * 
     * @param data
