...
public class AlignLayout extends ENHGridLayout {
    ...
    /**
     * Creates an aligner layout with 2 columns, a variable number of rows, and
     * a gap of 5 pixels.
     */
    public AlignLayout() {
        this(2, 5, 5);
    ...
    /**
     * Sets whether the control should be resized vertically to the height of
     * the largest component in its row (default: false). This value is ignored
     * for labels (the components in odd columns).
     */
