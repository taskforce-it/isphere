...
public class JPythonInterpreterDriver implements InterpreterDriver {
    ...
    static {
        ...
        // new String[] {""});
        System.setProperty("python.cachedir", System.getProperty("user.home") + File.separator + GlobalConfigure.TN5250J_FOLDER + File.separator);
    ...
    public void executeScriptFile(SessionPanel session, String scriptFile) throws InterpreterDriver.InterpreterException {
        ...
        try {
            ...
            Runnable interpretIt = new Runnable() {
                public void run() {
                    // PySystemState.initialize(System.getProperties(),null, new
                    // String[] {""},this.getClass().getClassLoader());
