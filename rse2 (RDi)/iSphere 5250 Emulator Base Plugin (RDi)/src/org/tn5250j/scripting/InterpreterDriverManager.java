...
/**
 * Class for managing interpreter drivers. This manager is responsible for
 * keeping track of loaded driver. Interpreter drivers are required to register
...
public class InterpreterDriverManager {
    ...
    /**
     * Private constructor There is no need for instantiating this class as all
     * methods are private. This private constructor is to disallow creating
    ...
    /**
     * Register a driver. Interpreter drivers call this method when they are
     * loaded.
     * 
    ...
    /**
     * Execute a script string Execute the string supplied according to the
     * langauge specified
     * 
    ...
    /**
     * Exceute a script file. The interpreter driver supporting the language for
     * this file is deduced from file name extension
     * 
    ...
    public static void executeScriptFile(SessionPanel session, String scriptFile) throws InterpreterDriver.InterpreterException {
        String extension = scriptFile.substring(scriptFile.lastIndexOf(EXTENSION_SEPARATOR) + 1);
