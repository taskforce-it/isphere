...
/**
 * Driver interface for scripting interpreter. Each language supported must
 * implement this interface. The implementation fo this interface will typically
 * delegate the work to the underlying third-party interpreter. The implementing
 * class must create an instance of itself and register it with
 * InterpreterDriverManager when it is loaded.
 * 
...
public interface InterpreterDriver {
     ...
     * @exception throw a InterpreterDriver.InterpreterException which wraps the
     *            exception throw by underlying interpreter
     */
    ...
    /**
     * Nested class for wrapping the exception throw by underlying interpreter
    ...
    public static class InterpreterException extends Exception {
        ...
        public String toString() {
            return "InterpreterException: underlying exception: " + _underlyingException;
        }
    }
}
