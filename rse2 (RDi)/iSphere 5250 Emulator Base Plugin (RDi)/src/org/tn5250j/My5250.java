...
public class My5250 implements BootListener, TN5250jConstants, SessionListener, EmulatorActionListener {
     ...
     * variable to make the jython jar available to scripting process. This
     * needs to be rewritten to loop through and obtain all jars in the user
     * directory. Maybe also additional paths to search.
     */
    private void initJarPaths() {

        String jarClassPaths = System.getProperty("python.path") + File.pathSeparator + "jython.jar" + File.pathSeparator + "jythonlib.jar"
