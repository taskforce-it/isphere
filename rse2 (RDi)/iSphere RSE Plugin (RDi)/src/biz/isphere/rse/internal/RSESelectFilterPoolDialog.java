...
public class RSESelectFilterPoolDialog extends XDialog {
    ...
    private ISystemFilterPool[] filterPools;

    private TableViewer tableViewer;
    private ISystemFilterPool selectedFilterPool;

    public RSESelectFilterPoolDialog(Shell parentShell, ISystemFilterPool[] filterPools) {
        super(parentShell);
        ...
        tableViewer.addSelectionChangedListener(new ISelectionChangedListener() {
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (event.getSelection() instanceof StructuredSelection) {
                    ...
                    selectedFilterPool = (ISystemFilterPool)selection.getFirstElement();
                }
            }
        });
    ...
    public ISystemFilterPool getSelectedFilterPool() {

        return selectedFilterPool;
    }

    public void setSelectedFilterPool(ISystemFilterPool filterPool) {
    ...
    private class RSESelectFilterPoolContentProvider implements IStructuredContentProvider {
        ...
        private ISystemFilterPool[] pools;
        ...
        public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
            pools = (ISystemFilterPool[])newInput;
        }
    }
