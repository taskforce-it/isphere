...
public class Access {
    ...
    public static void openTN5250JDesigner(String _rseProfil, String _rseConnection, String _library, String _file, String _member, String _editor,
        boolean _readOnly, String _currentLibrary, String _libraryList) throws Exception {
        ...
        if (session != null) {
            ...
            try {
                ...
                if (area.equals("*VIEW")) {
                    ...
                    tn5250jPart = (ITN5250JPart)UIHelper.getActivePage().showView("biz.isphere.tn5250j.rse.designerview.DesignerView");

                } else if (area.equals("*EDITOR")) {

                    TN5250JEditorInput editorInput = new TN5250JEditorInput("biz.isphere.tn5250j.rse.designereditor.DesignerEditor",
                        "TN5250J Designer", "TN5250J", TN5250JRSEPlugin.getDefault().getImageRegistry().get(TN5250JRSEPlugin.IMAGE_TN5250J));

                    tn5250jPart = (ITN5250JPart)UIHelper.getActivePage().openEditor(editorInput,
    ...
    public static void setServiceEntryPoint(Shell shell, String _rseProfil, String _rseConnection, String _library, String _object, String _objectType)
        ...
        Runnable runnable = new SetSEPAsync(shell, sessionInfo, _library, _object, _objectType);
