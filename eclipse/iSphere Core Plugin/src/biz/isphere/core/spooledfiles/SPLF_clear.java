...
public class SPLF_clear {
    ...
    public int run(AS400 _as400, int handle) {
        ...
        try {
            ...
            ProgramCallDocument pcml = new ProgramCallDocument(_as400, "biz.isphere.core.spooledfiles.SPLF_clear", this.getClass().getClassLoader());
            ...
            if (rc == false) {
                ...
                ISpherePlugin.logError("*** Call to SPLF_clear failed. See messages above ***", null);
            ...
            // e.printStackTrace();
            // Xystem.out.println("*** Call to SPLF_clear failed. ***");
            // return null;
            ISpherePlugin.logError("*** Call to SPLF_clear failed. See messages above ***", null);
        }
