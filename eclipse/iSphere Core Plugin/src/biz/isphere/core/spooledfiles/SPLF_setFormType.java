...
public class SPLF_setFormType {
    ...
    public int run(AS400 _as400, String _formType) {

        int errno = 0;

        try {

            ProgramCallDocument pcml = new ProgramCallDocument(_as400, "biz.isphere.core.spooledfiles.SPLF_setFormType", this.getClass()
                .getClassLoader());
            ...
            if (rc == false) {
                ...
                ISpherePlugin.logError("*** Call to SPLF_setFormType failed. See messages above ***", null);
            ...
            // return null;
            ISpherePlugin.logError("*** Call to SPLF_setFormType failed. See messages above ***", e);
        }
