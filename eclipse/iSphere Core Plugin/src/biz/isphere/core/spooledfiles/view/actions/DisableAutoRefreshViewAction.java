...
public class DisableAutoRefreshViewAction extends AutoRefreshRefreshIntervalAction {

    public DisableAutoRefreshViewAction(IAutoRefreshView view) {
        super(view, REFRESH_OFF);
