...
public class ViewSearchResults extends ViewPart implements ISelectionChangedListener {
    ...
    private void saveSearchResult() {
        ...
        if (viewer != null) {
            ...
            try {
                ...
                // DoNotAskMeAgainDialog.CONFIRM_OPEN_SAVED_FILE_STREAM_FILE_SEARCH,
                // file);
    ...
    private void loadAutoSaveSearchResults() {
        ...
        try {
            ...
            ISpherePlugin.logError("Failed to load stream file search results.", e); //$NON-NLS-1$
        }
    }
    ...
    public void dispose() {
        ...
        try {
            ...
            ISpherePlugin.logError("Failed to save stream file search results.", e); //$NON-NLS-1$
        }
