...
public class SearchDialog extends AbstractSearchDialog<SearchElement> {
    ...
    public SearchDialog(Shell parentShell, HashMap<String, SearchElement> searchElements) {
        super(parentShell, SearchArgument.MAX_SOURCE_FILE_SEARCH_COLUMN, false, SearchOptions.MAX_STRING_SIZE_SOURCE_FILE_SEARCH, false);
        init(searchElements);
    }
    ...
    public SearchDialog(Shell parentShell, HashMap<String, SearchElement> searchElements, boolean searchArgumentsListEditor) {
        super(parentShell, SearchArgument.MAX_SOURCE_FILE_SEARCH_COLUMN, searchArgumentsListEditor, SearchOptions.MAX_STRING_SIZE_SOURCE_FILE_SEARCH,
            true, SearchOptionConfig.getAdditionalLineModeSearchOptions());
        init(searchElements);
    }
