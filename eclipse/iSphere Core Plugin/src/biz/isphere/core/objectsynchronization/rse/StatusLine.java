...
public final class StatusLine {
    ...
    private String message = Messages.EMPTY;
    ...
    public void fill(Composite parent) {
        ...
        if (showNumItems) {
            ...
            numItemsLabel.setText(Messages.EMPTY);
        ...
        if (showMessage) {
            ...
            messageLabel.setText(Messages.EMPTY);
        }
    ...
    private void updateControls() {
        ...
        if (isOKForUpdate(messageLabel)) {
            if (message != null) {
                ...
                messageLabel.setText(Messages.EMPTY);
                messageLabel.setToolTipText(Messages.EMPTY);
            }
