...
public class CommandEditingAreaRepository extends AbstractCommandEditingArea {

    public CommandEditingAreaRepository(Composite parent, AbstractResource[] resources, boolean both, boolean singleCompileType) {
