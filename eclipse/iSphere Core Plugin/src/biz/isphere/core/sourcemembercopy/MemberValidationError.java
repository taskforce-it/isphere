...
public enum MemberValidationError {
    ...
    ERROR_TO_FILE_NAME_NOT_VALID (true, SynchronizeMembersAction.CANCEL),
    ERROR_TO_FILE_NOT_FOUND (true, SynchronizeMembersAction.CONTINUE),
    ...
    ERROR_TO_MEMBER_OUT_OF_NAMES (true, SynchronizeMembersAction.CONTINUE_WITH_ERROR),
    ...
    private MemberValidationError(boolean isError, SynchronizeMembersAction action) {
