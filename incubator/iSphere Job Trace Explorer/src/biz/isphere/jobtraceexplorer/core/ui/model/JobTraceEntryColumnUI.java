...
public enum JobTraceEntryColumnUI {
    ...
    NANOS_SINE_STARTED (
        ...
        Messages.Tooltip_Nanoseconds_since_collection_started,
        160),
    ...
    HLL_STMT_NBR (ColumnsDAO.HLL_STMT_NBR.name(), ColumnsDAO.HLL_STMT_NBR.description(), Messages.Tooltip_HLL_statement_number, 40),
    ...
    CALLER_HLL_STMT_NBR (
        ColumnsDAO.CALLER_HLL_STMT_NBR.name(),
