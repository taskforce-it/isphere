...
public class OpenJobLogExplorerWithRemoteFileAction implements IWorkbenchWindowActionDelegate, IObjectActionDelegate {

    public static final String ID = "biz.isphere.joblogexplorer.action.OpenJobLogExplorerWithRemoteFileAction"; //$NON-NLS-1$
