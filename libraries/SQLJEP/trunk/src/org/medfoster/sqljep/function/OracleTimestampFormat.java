...
public class OracleTimestampFormat extends Format {
    ...
    static {
        OracleTimestampFormat.timeSymbols.add(new NNN());
    }

    /**
     * Oracle date format: Seconds past midnight
     */
    ...
    private static void eatNumbers(String source, ParsePosition pos, int digits) throws ParseException {
    ...
    private static int getNumber(String source, ParsePosition pos, int digits) throws java.text.ParseException, NumberFormatException {
        final int len = source.length();
        String d = "";
        int i;
        for (i = pos.getIndex(); i < len; i++) {
