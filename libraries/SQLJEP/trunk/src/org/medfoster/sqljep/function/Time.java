...
public class Time extends PostfixCommand {
	...
	public void evaluate(ASTFunNode node, JepRuntime runtime) throws ParseException {
		...
		if (num == 1) {
			...
			runtime.stack.push(to_time(param1, ParserUtils.getTimeFormat((String) param1)));
		} else if (num == 2) {
	...
	public static java.sql.Time to_time(Comparable expression, Comparable pattern) throws ParseException {
        ...
        if (expression instanceof java.sql.Time) {
            ...
            try {
                ...
                return (java.sql.Time)format.parseObject((String)expression);
            ...
            throw createWrongTypeException("TIME", expression, pattern);
        }
	}
}
