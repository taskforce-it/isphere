...
public class Lpad extends PostfixCommand {
    ...
    public void evaluate(ASTFunNode node, JepRuntime runtime) throws ParseException {
        ...
        if (num == 2) {
            ...
            runtime.stack.push(lpad(param1, param2, " "));
        } else if (num == 3) {
            Comparable<?> param3 = runtime.stack.pop();
            Comparable<?> param2 = runtime.stack.pop();
            Comparable<?> param1 = runtime.stack.pop();
            runtime.stack.push(lpad(param1, param2, param3));
        } else {
    ...
    public String lpad(Comparable<?> param1, Comparable<?> param2, Comparable<?> param3) throws ParseException {
        ...
        try {
            ...
            // Length in lpad shoud be integer
