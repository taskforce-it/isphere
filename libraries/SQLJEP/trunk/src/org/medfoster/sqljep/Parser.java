...
import org.medfoster.sqljep.function.ComparativeGE;
import org.medfoster.sqljep.function.ComparativeGT;
import org.medfoster.sqljep.function.ComparativeIsNotNull;
import org.medfoster.sqljep.function.ComparativeIsNull;
import org.medfoster.sqljep.function.ComparativeLE;
import org.medfoster.sqljep.function.ComparativeLT;
import org.medfoster.sqljep.function.ComparativeNE;
import org.medfoster.sqljep.function.Concat;
import org.medfoster.sqljep.function.Divide;
import org.medfoster.sqljep.function.In;
import org.medfoster.sqljep.function.Like;
import org.medfoster.sqljep.function.LogicalAND;
import org.medfoster.sqljep.function.LogicalNOT;
import org.medfoster.sqljep.function.LogicalOR;
import org.medfoster.sqljep.function.Modulus;
import org.medfoster.sqljep.function.Multiply;
import org.medfoster.sqljep.function.NotBetween;
import org.medfoster.sqljep.function.NotLike;
...
public class Parser/* @bgen(jjtree) */implements ParserTreeConstants, ParserConstants {/*
    ...
    public Node parseStream(java.io.Reader stream, BaseJEP jep_in) throws ParseException {
        ReInit(stream);
        jep = jep_in;
    ...
    final public void EqualExpression() throws ParseException {
        ...
        label_3: while (true) {
            ...
            case NE_2:
                ...
                try {
                    jj_consume_token(NE_2);
                    RelationalExpression();
                    jjtree.closeNodeScope(jjtn002, 2);
                    jjtc002 = false;
                    jjtn002.setFunction(tokenImage[NE_2], new ComparativeNE());
            ...
            case EQ:
                ...
                try {
                    ...
                    jjtc003 = false;
                    jjtn003.setFunction(tokenImage[EQ], new ComparativeEQ());
        ...
        case NOT_REGEXP_LIKE:
            ...
            case NOT_BETWEEN:
                ...
                try {
                    ...
                    jjtc005 = false;
                    jjtn005.setFunction(tokenImage[NOT_BETWEEN], new NotBetween());
            ...
            case LIKE:
                ...
                try {
                    ...
                    jjtc006 = false;
                    jjtn006.setFunction(tokenImage[LIKE], new Like());
            ...
            case NOT_LIKE:
                ...
                try {
                    ...
                    jjtc007 = false;
                    jjtn007.setFunction(tokenImage[NOT_LIKE], new NotLike());
            ...
            case REGEXP_LIKE:
                ...
                try {
                    ...
                    jjtc008 = false;
                    jjtn008.setFunction(tokenImage[REGEXP_LIKE], new Regexp_Like());
            ...
            case NOT_REGEXP_LIKE:
                ...
                try {
                    jj_consume_token(NOT_REGEXP_LIKE);
                    AdditiveExpression();
                    jjtree.closeNodeScope(jjtn009, 2);
                    jjtc009 = false;
                    jjtn009.setFunction(tokenImage[NOT_REGEXP_LIKE], new NotRegexp_Like());
    ...
    final public void UnaryExpressionNotPlusMinus() throws ParseException {
        ...
        default:
            jj_la1[15] = jj_gen;
            if (jj_2_3(1)) {
                if (getToken(1).kind == IDENTIFIER && BaseJEP.hasFunction(getToken(1).image)) {
                    Function();
                } else {
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case IDENTIFIER:
    ...
    final private boolean jj_3_3() {
        ...
        xsp = jj_scanpos;
        lookingAhead = true;
        jj_semLA = getToken(1).kind == IDENTIFIER && BaseJEP.hasFunction(getToken(1).image);
        lookingAhead = false;
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[] { 0x1, 0x100000, 0x80000, 0x64000, 0x64000, 0x1b000, 0x1b000, 0x7fc00000, 0x7fc00000, 0x1c0, 0x1c0, 0xe00, 0xe00,
            0x200180, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x80000000, };
    }

    private static void jj_la1_1() {
        jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x57, 0x800, 0x2000, 0x2000, 0x57, };
    }
