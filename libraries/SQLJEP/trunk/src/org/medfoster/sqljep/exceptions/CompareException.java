...
public class CompareException extends ParseException {
    ...
    public CompareException(Comparable<?> param1, Comparable<?> param2) {
        this.param1 = param1;
        this.param2 = param2;
    }
    ...
    public String getMessage() {
        return String.format("Cannot compare '%s' with '%s'.", param1.getClass().getSimpleName(), param2.getClass().getSimpleName());
    }
}
